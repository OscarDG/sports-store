...
export default function SearchBar(){
    return (
        <div className='search_bar absolute top-28 md:top-8 flex flex-row justify-center items-center w-[80%] md:w-[50%] h-[20%] md:h-[25%] rounded-[20px] border-1 border-mainred'>
