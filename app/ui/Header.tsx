    ...
    return (
        <header className={clsx(`${monaSans.className} fixed flex flex-row justify-center align-middle w-[100%] h-[15%] z-20`, sticky? `bg-mainwhite/80`: `bg-transparent`)}>
            <nav className="relative flex md:flex-row flex-col justify-center md:justify-end items-end md:items-center w-[100%] h-[100%]">
                ...
                <ul className={clsx(visible? `flex absolute shadow-md bg-white/50`: `hidden md:flex`, `md:relative top-[100%] flex-col justify-evenly items-center w-[100%] h-[120%] text-[1.5rem] md:text-[1.5rem] md:top-[0%] rounded-b-[20px] md:rounded-b-none p-5 list-none md:flex-row md:mr-10 md:w-[40%] md:h-[90%] md:shadow-none md:text-mainwhite text-black md:bg-transparent`)}>
                    <li className="relative flex flex-col items-center justify-center w-[18%] h-[90%] text-center mb-2 after:content-[''] after:relative after:w-[90%] after:h-[2px] after:bg-mainred after:rounded-sm after:scale-x-0 after:transition-transform after:duration-300 after:ease-in hover:after:scale-x-100"><a href="/" target="_blank">Home</a></li>  
