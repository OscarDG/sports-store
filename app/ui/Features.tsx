...
export default function Features(){
    return (
        <section className="relative flex flex-col justify-evenly items-center w-[100%] h-[250vh] md:h-[150vh]">
            ...
            <div className="relative flex flex-row flex-wrap justify-evenly items-center w-[100%] h-[400px] md:h-[350px] bg-[url(@/public/sunset.webp)] bg-center bg-no-repeat bg-cover">
