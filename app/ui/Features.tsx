...
export default function Features(){
    return (
        <section className="relative flex flex-col justify-evenly items-center w-[100%] h-[230vh] md:h-[150vh]">
            <div className="relative flex flex-col md:flex-row justify-center md:justify-evenly items-center w-[95%] h-auto">
                <FeaturesCart />
            </div>
            <div className="relative flex flex-row flex-wrap justify-evenly items-center w-[100%] h-[40%] bg-[url(@/public/sunset.webp)] bg-center bg-no-repeat bg-cover">
