...
export default function Footer (){
    ...
    return (
        <footer className={`relative flex flex-col md:flex-row justify-center items-center w-[100%] h-[350px] ${monaSans.className} bg-mainwhite drop-shadow-lg drop-shadow-cyan-300`}>
            <Newsletter />
            ...
            <div className="absolute flex flex-row justify-center items-center bottom-0 w-[100%] h-[50px] bg-mainred text-mainwhite font-medium">
